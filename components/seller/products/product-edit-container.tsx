      ...
      <Tabs defaultValue="basic" className="space-y-6">
        ...
        <TabsContent value="specs" className="space-y-6">
          <div className="bg-card border rounded-lg p-6">
             ...
             <ProductSpecificationForm product={product} onUpdate={fetchProduct} />
          </div>
        </TabsContent>
        ...
        <TabsContent value="commercial" className="space-y-6">
          <div className="bg-card border rounded-lg p-6">
             ...
             <ProductCommercialForm product={product} onUpdate={fetchProduct} />
          </div>
        </TabsContent>
        ...
        <TabsContent value="compliance">
          <div className="bg-card border rounded-lg p-6">
            ...
            <ProductComplianceForm product={product} onUpdate={fetchProduct} />
          </div>
        </TabsContent>
