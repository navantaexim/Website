...
const updateSellerSchema = z.object({
  ...
  yearEstablished: z.number().int().max(new Date().getFullYear(), 'Year Established cannot be in the future'),
...
export async function PUT(request: Request) {
  try {
    ...
    const { sellerId, legalName, businessType, yearEstablished, gstNumber, iecCode, panNumber, cinOrLlpin } = validationResult.data
